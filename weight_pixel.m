function [representation_score, min_F_hat_layers, alphas_1, alphas_2] = weight_pixel(image,color_model,representation_score)
    [rows, cols, ~] = size(image);
    num_layers_times_3 = size(color_model,1);
    min_F_hat_layers = zeros(rows, cols, 2);
    min_F_hat_energy = Inf * ones(rows, cols);
